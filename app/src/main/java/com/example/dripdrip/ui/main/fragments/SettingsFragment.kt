...
import com.example.dripdrip.ui.main.viewmodels.SettingsViewModel
import com.example.dripdrip.ui.slideUpViews
...
class SettingsFragment : Fragment(R.layout.fragment_settings) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        etUssername.addTextChangedListener {
            btnUpdateProfile.isEnabled = true
        }
       ...
       btnUpdateProfile.setOnClickListener {
              val username = etUssername.text.toString()
    ...
    private fun subscribeToObservers() {
        viewModel.getUserStatus.observe(viewLifecycleOwner, EventObserver(
            ...
            etUssername.setText(user.username)
