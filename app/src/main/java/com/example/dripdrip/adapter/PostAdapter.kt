package com.example.dripdrip.adapter
...
class PostAdapter @Inject constructor(
    ...
    class PostViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val ivAuthorPofileImage: ImageView = itemView.ivAuthorProfileImage
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int) {
        ...
        holder.apply {
            ...
            glide.load(post.authorProfilePictureUrl).into(ivAuthorPofileImage)
